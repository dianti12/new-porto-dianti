                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 ml-auto" data-aos="fade-up" data-aos-delay="100">
                        <div class="mb-4">
                            ...
                            <!-- ini inputan deskripsi yang template -->
                        ...
                        <form action="#" method="POST" class="p-5 bg-white">
                            ...
                            <div class="row form-group">
                                <div class="col-md-12">
                                    ...
                                    <textarea name="message" id="message" cols="30" rows="7" class="form-control" placeholder="Write your notes or questions here...">
                            ...
                            <div class="row form-group">
                                <div class="col-md-12">
                                    <input name="simpan" type="submit" value="Send Message" class="btn btn-primary btn-md text-white">
                                </div>
                            </div>
